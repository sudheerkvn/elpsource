        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-reward" data-toggle="tab"><?php echo $tab_reward; ?></a></li>
				...
				<?php if ($affiliate_module_install) { ?>
				<li><a href="#tab-affilate" data-toggle="tab"><?php echo $tab_affilate; ?></a></li>
				<?php } ?>
          ...
          <div class="tab-content">
			...
			<?php if ($affiliate_module_install) { ?>
				<div class="tab-pane" id="tab-affilate">
				<div class="table-responsive">
				<!--<button type="button" onclick="addAffilate();" data-toggle="tooltip" title="<?php echo $button_add_affilate; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button>-->
		 			<table id="affilate" class="table table-striped table-bordered table-hover">
            			<thead id="affilate-column">
              				<tr>
								<?php foreach($pf_columns as $pf_column) { ?>
									<td class="left"><?php echo $pf_column['title']; ?></td>
								<?php } ?>
								<td>&nbsp;</td>
							</tr>
						</thead>
						<?php $affilate_row = 0; ?>
						<?php if (isset($product_affilates)) { ?>
						<?php foreach ($product_affilates as $product_affilate) { ?>
						<tbody id="affilate-row<?php echo $affilate_row; ?>">
			  			<tr>
							<?php $columns = $product_affilate['columns']; ?>
							<?php $c = 0; ?>
							<?php foreach($columns as $key => $data) { ?>
							<?php if($data['type'] == 'price' || $data['type'] == 'url' || $data['type'] == 'texxt') { ?>
							<td class="text-left">
								<input type="text" name="product_affilate[<?php echo $affilate_row; ?>][<?php echo $key; ?>]" value="<?php echo $data['value']; ?>" placeholder="" id="affilate_description<?php echo $affilate_row; ?>" class="form-control" />
							</td>
							<?php } elseif($data['type'] == 'image') { ?>
							<td class="text-left">
								<a href="" id="thumb_shop<?php echo $affilate_row.$c; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $data['url']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
								<input type="hidden" name="product_affilate[<?php echo $affilate_row; ?>][<?php echo $key; ?>]" value="<?php echo $data['value']; ?>" id="shop<?php echo $affilate_row.$c; ?>" />
							</td>
							<?php ++$c; ?>
							<?php } elseif($data['type'] == 'stores') { ?>
							<td class="text-left">
								<div class="scrollbox">
						  			<?php $class = 'even'; ?>
						  			<div class="<?php echo $class; ?>">
										<?php if (in_array(0, $data['value'])) { ?>
										<input type="checkbox" name="product_affilate[<?php echo $affilate_row; ?>][<?php echo $key; ?>][]" value="0" checked="checked" />
										<?php echo $text_default; ?>
										<?php } else { ?>
										<input type="checkbox" name="product_affilate[<?php echo $affilate_row; ?>][<?php echo $key; ?>][]" value="0" />
										<?php echo $text_default; ?>
										<?php } ?>
						  			</div>
						  			<?php foreach ($stores as $store) { ?>
						  			...
						  			<div class="<?php echo $class; ?>">
										<?php if (in_array($store['store_id'], $data['value'])) { ?>
										<input type="checkbox" name="product_affilate[<?php echo $affilate_row; ?>][<?php echo $key; ?>][]" value="<?php echo $store['store_id']; ?>" checked="checked" />
										<?php echo $store['name']; ?>
										<?php } else { ?>
										<input type="checkbox" name="product_affilate[<?php echo $affilate_row; ?>][<?php echo $key; ?>][]" value="<?php echo $store['store_id']; ?>" />
										<?php echo $store['name']; ?>
										<?php } ?>
						  			</div>
						  			<?php } ?>
							...
							<td>
								<button type="button" onclick="$('#affilate-row<?php echo $affilate_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>
							</td>
			 			</tr>
            			</tbody>
            			<?php $affilate_row++; ?>
...
//--></script></div>
			...
			<script type="text/javascript"><!--
			<?php if ($affiliate_module_install) { ?>
			var affilate_row = <?php echo $affilate_row; ?>;
			var affilate_column = 0;
			
			function addAffilate() {
				html  = '<tbody id="affilate-row' + affilate_row + '">';
				html += '  <tr>'; 
				<?php foreach($pf_columns as $pf_column) { ?>
					<?php if($pf_column['type'] == 'price') { ?>
						html += '    <td class="text-left"><input type="text" name="product_affilate[' + affilate_row + '][<?php echo $pf_column['id']; ?>]" value="" /></td>';
					<?php } elseif($pf_column['type'] == 'stores') { ?>
						html += '    <td class="text-left">';
						html += '    <div class="scrollbox">';
									  <?php $class = 'even'; ?>
						html += '     <div class="<?php echo $class; ?>">';
						html += '    	<input type="checkbox" name="product_affilate[' + affilate_row + '][<?php echo $pf_column['id']; ?>][]" value="0" />';
						html += '		<?php echo $text_default; ?>';
						html += '	  </div>';
									  <?php foreach ($stores as $store) { ?>
									  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
						html += '	  <div class="<?php echo $class; ?>">';
						html += '		<input type="checkbox" name="product_affilate[' + affilate_row + '][<?php echo $pf_column['id']; ?>][]" value="<?php echo $store['store_id']; ?>" />';
						html += '		<?php echo $store['name']; ?>';
						html += '	  </div>';
									  <?php } ?>
						html += '	</div>';
						html += '	</td>';
					<?php } elseif($pf_column['type'] == 'texxt') { ?>
						html += '    <td class="text-left"><input type="text" name="product_affilate[' + affilate_row + '][<?php echo $pf_column['id']; ?>]" value="" /></td>';
					<?php } elseif($pf_column['type'] == 'url') { ?>
						html += '    <td class="text-left"><input type="text" name="product_affilate[' + affilate_row + '][<?php echo $pf_column['id']; ?>]" value="" /></td>';
					<?php } elseif($pf_column['type'] == 'image') { ?>
						html += '    <td class="text-left"><a href="" id="thumb_shop' + affilate_row + affilate_column + '" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /><input type="hidden" name="product_affilate[' + affilate_row + '][<?php echo $pf_column['id']; ?>]" value="" id="shop' + affilate_row + affilate_column + '" /><br /></td>';
						++affilate_column;
					<?php } ?>
					
				<?php } ?>
			
				html += '    <td class="text-left"><a onclick="$(\'#affilate-row' + affilate_row + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></a>';
				
				html += '  </tr>';	
				html += '</tbody>';
				
				$('#affilate tfoot').before(html);
